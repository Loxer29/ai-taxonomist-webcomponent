...
export class PlantNetBrand extends LitElement {
    ...
    connectedCallback() {
        ...
        const aiTaxonomistRootNodeClassList = this.getRootNode().host.parentNode.getRootNode().host.classList;
...
], PlantNetBrand.prototype, "darkMode", void 0);
//# sourceMappingURL=PlantNetBrand.js.map