...
export class SpeciesList extends LitElement {
    ...
    __onSearch(event) {
        ...
        this.filter = (((_a = event === null || event === void 0 ? void 0 : event.currentTarget) === null || _a === void 0 ? void 0 : _a.value) || '').trim();
        if ((_b = this.filter) === null || _b === void 0 ? void 0 : _b.length) {
            const filterValue = this.filter.toLowerCase();
            this.displayedSpecies = this.species.filter((el) => {
    ...
    render() {
        ...
        return html ` <p>
            ...
            />
            <ul>
                ${this.displayedSpecies.map(species => html `
                        <li class="result">
                            <a
...
], SpeciesList.prototype, "apiUrl", void 0);
__decorate([
    property({ attribute: false })
], SpeciesList.prototype, "species", void 0);
__decorate([
    property({ attribute: false })
], SpeciesList.prototype, "displayedSpecies", void 0);
__decorate([
    property({ attribute: false })
], SpeciesList.prototype, "filter", void 0);
__decorate([
    property({ attribute: false })
], SpeciesList.prototype, "error", void 0);
