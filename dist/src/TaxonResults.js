...
export class TaxonResults extends LitElement {
    constructor() {
        ...
        this.error = null;
        this.loading = false;
        this.plantnetBrand = false;
    }
    onAttachmentClick(result) {
        return (e) => {
            e.preventDefault();
            const detail = result;
            this.dispatchEvent(new CustomEvent('aiTaxonomistAttachmentsClick', {
                detail,
                bubbles: true,
                composed: true,
                cancelable: true,
    ...
    render() {
        const template = (document.getElementById('aitaxonomist-attachments-template'));
        const loading = this.loading ? html ` <ai-loader></ai-loader>` : null;
        const error = this.error ? html `<p>${this.error}</p>` : null;
        const maxResults = 8;
        const hasExtraResults = this.results.results.length > maxResults
        ...
        return html `
            <div class="container">
                ...
                <ul>
                    ${this.results.results.slice(0, maxResults).map(result => html `
                            <li class="result">
...
], TaxonResults.prototype, "results", void 0);
__decorate([
    property({ type: Boolean })
], TaxonResults.prototype, "error", void 0);
__decorate([
    property({ type: Boolean })
], TaxonResults.prototype, "loading", void 0);
__decorate([
    property({ type: Boolean })
], TaxonResults.prototype, "plantnetBrand", void 0);
//# sourceMappingURL=TaxonResults.js.map