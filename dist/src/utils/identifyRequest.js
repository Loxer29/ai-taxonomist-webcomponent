import { BackendFormat } from './types.js';
import { formatC4CRequest, formatC4CResponse, formatCarpersoResponse, formatCarpesoRequest, formatPlantNetRequest, formatPlantNetResponse, } from './identifyRequestUtils.js';
const formatRequest = (images, apiUrl, apiKey, backendFormat) => {
...
export const identifyRequest = async (images, apiUrl, apiKey, backendFormat) => {
...
export const getGBIFDoi = async (apiUrl, backendFormat) => {
...
//# sourceMappingURL=identifyRequest.js.map